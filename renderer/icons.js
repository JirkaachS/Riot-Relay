...
/* ============================================================
   icons.js — Lucide icon set (vendored, MIT).
   https://lucide.dev — outline icons, 24x24, currentColor stroke.
   Exposes Icons.svg(name, size) and auto-injects into [data-icon].
   ============================================================ */
...
const LUCIDE = {
  ...
  sheet: '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="3" x2="21" y1="9" y2="9"/><line x1="3" x2="21" y1="15" y2="15"/><line x1="9" x2="9" y1="3" y2="21"/><line x1="15" x2="15" y1="3" y2="21"/>',
...
const Icons = {
  svg(name, size = 18, opts = {}) {
    const body = LUCIDE[name] || '';
    const fill = opts.fill ? 'currentColor' : 'none';
    const cls = opts.class ? ` class="${opts.class}"` : '';
    return `<svg${cls} xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" `
      + `fill="${fill}" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${body}</svg>`;
  },
  inject(root = document) {
    root.querySelectorAll('[data-icon]').forEach((el) => {
      ...
      el.innerHTML = Icons.svg(name, size, { fill });
    });
  },
};
